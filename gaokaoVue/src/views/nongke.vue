<template>
  <div class="box">
    <div class="image1">
      <img src="../assets/zhuanyePK/nongke1.jpg" alt="">
    </div>
    <div class="image2">
      <img src="../assets/zhuanyePK/nongke2.jpg" alt="">
    </div>
    <h1>农科提前批院校专业</h1>
    ...
    <div class="kuangjia">
      <div class="leftBox">
        ...
        <div class="content">
          ...
          <p>{{ school1.detail.type1 }}型:</p> -->
          <p>年份: {{ school1.detail.year }}</p>
      ...
      <div class="rightBox">
        ...
        <div class="content">
          ...
          <p>{{ school2.detail.type1 }}型:</p> -->
          <p>年份: {{ school2.detail.year }}</p>
...
export default {
  ...
  methods: {
    ...
    async SearchSchool1Sp() {
      ...
      const result = await request.get("schoolPk/nongke", {
        params: {
    ...
    async SearchSchool1detail() {
      const result = await request.get("schoolPk/nongkedetail", {
        params: {
          schoolname: this.school1.schoolname,
          specialty: this.school1.zhuanye
        }
