<template>
  <div class="box">
    <div class="image1"><img src="../assets/zhuanyePK/student8.jpg" alt=""></div>
    <div class="image2"><img src="../assets/zhuanyePK/student2.jpg" alt=""></div>
    <h1>本科提前批院校专业</h1>
...
export default {
  ...
  methods: {
    ...
    async SearchSchool1Sp() {
      ...
      const result = await request.get("schoolPk/bk", {
        params: {
    ...
    async SearchSchool1detail() {
      const result = await request.get("schoolPk/bkdetail", {
        params: {
          schoolname: this.school1.schoolname,
          specialty: this.school1.zhuanye
        }
