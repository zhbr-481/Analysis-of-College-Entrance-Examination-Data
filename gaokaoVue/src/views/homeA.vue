<template>
  <div>
    <el-row>
      ...
      <el-col :span="18">
        <div class="lunbo">
          <el-carousel :interval="5000" arrow="always" class="Carousel" height="600px" >
            <el-carousel-item v-for="(image, index) in imageList" :key="index" class="el-carousel-item">
              <img :src="image" alt="轮播图" style="width: 100%; height: 100%;">
            </el-carousel-item>
          </el-carousel>
        </div>
      </el-col>
