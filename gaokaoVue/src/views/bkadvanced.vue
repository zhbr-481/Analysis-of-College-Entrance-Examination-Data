<template>
  <div class="box">
    <div class="image1">
      <img src="../assets/zhuanyePK/junren2.jpg" alt="">
    </div>
    <div class="image2">
      <img src="../assets/zhuanyePK/junren1.jpg" alt="">
    </div>
    <h1>军士提前批专业</h1>
...
export default {
  ...
  methods: {
    ...
    async SearchSchool1Sp() {
      ...
      const result = await request.get("schoolPk/solider", {
        params: {
    ...
    async SearchSchool1detail() {
      const result = await request.get("schoolPk/soliderdetail", {
        params: {
          schoolname: this.school1.schoolname,
          specialty: this.school1.zhuanye
        }
