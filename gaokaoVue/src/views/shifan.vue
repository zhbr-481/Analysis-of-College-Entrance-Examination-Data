<template>
  <div class="box">
    <div class="image1"><img src="../assets/zhuanyePK/teacher3.jpg" alt=""></div>
    <div class="image2"><img src="../assets/zhuanyePK/teacher6.jpg" alt=""></div>
    <h1>师范提前批专业</h1>
...
export default {
  ...
  methods: {
    ...
    async SearchSchool1Sp() {
      ...
      const result = await request.get("schoolPk/shifan", {
        params: {
    ...
    async SearchSchool1detail() {
      const result = await request.get("schoolPk/shifandetail", {
        params: {
          schoolname: this.school1.schoolname,
          specialty: this.school1.zhuanye
        }
