<template>
  <div class="box">
    <div class="image1">
      <img src="../assets/zhuanyePK/student5.jpg" alt="">
    </div>
    <div class="image2">
      <img src="../assets/zhuanyePK/student4.jpg" alt="">
    </div>
    <h1>二段院校专业</h1>
...
export default {
  ...
  methods: {
    ...
    async SearchSchool1Sp() {
      ...
      const result = await request.get("schoolPk/second", {
        params: {
    ...
    async SearchSchool1detail() {
      const result = await request.get("schoolPk/seconddetail", {
        params: {
          schoolname: this.school1.schoolname,
          specialty: this.school1.zhuanye
        }
